...
type FormProps<M extends "employees" | "leave" | "attendance" | "payroll" | "performance"> = {
...
// ---------------------------------------------------------------------
export function EmployeesSetupForm({ initial }: FormProps<"employees">) {
  ...
  return (
    <Card>
      ...
      <CardContent className="space-y-4">
        ...
        <SetupActions module="employees" getConfig={() => ({ departments: depts.filter((d) => d.name.trim()) })} />
      </CardContent>
    </Card>
  );
}
...
// ---------------------------------------------------------------------
export function LeaveSetupForm({ initial }: FormProps<"leave">) {
...
// ---------------------------------------------------------------------
export function AttendanceSetupForm({ initial }: FormProps<"attendance">) {
  ...
  return (
    <div className="space-y-6">
      ...
      <SetupActions module="attendance" getConfig={() => ({ shifts: shifts.filter((s) => s.name.trim()), policy: p })} />
    </div>
  );
}
...
// Pay cycle & statutory
// ---------------------------------------------------------------------
export function PayrollSetupForm({ initial }: FormProps<"payroll">) {
  ...
  return (
    <div className="space-y-6">
      ...
      <SetupActions module="payroll" getConfig={() => ({ schedule, pension, tax, components })} />
    </div>
  );
}
...
// First review cycle
// ---------------------------------------------------------------------
export function PerformanceSetupForm({ initial, note }: FormProps<"performance">) {
  ...
  return (
    <Card>
      ...
      <CardContent className="space-y-4">
        ...
        <SetupActions module="performance" getConfig={() => ({ cycle: c })} />
      </CardContent>
    </Card>
  );
}
