...
export const HELP_GUIDES: HelpGuide[] = [
  ...
  {
    slug: "make-a-course",
    title: "Make a course and assign it",
    roles: ["owner", "hr"],
    intro: "Courses are short lessons staff take on their phone: text, a video link, a PDF or a quiz. When they finish, they get a certificate.",
    steps: [
      "Open Training and select New course. Give it a name and a pass mark for quizzes.",
      "Select Add a lesson. Choose Text, Video link, PDF or Quiz. For a quiz, save it, then select Add a question and tick the right answer.",
      "When the lessons are ready, select Publish.",
      "Open the People tab. Choose who takes it: a department, a job, a location, one person or everyone. Add a due date if you like, then select Assign.",
      "Everyone it covers gets a notification. People who join that group later get the course too.",
      "The People tab shows who has started, finished or is overdue. Reminders go out a few days before the due date.",
    ],
    wrong: [
      '"Add at least one lesson" or "the quiz has no questions": finish the lessons first, then publish.',
      "Someone can't see the course: check it's published and assigned to a group they're in.",
    ],
  },
  {
    slug: "take-a-course",
    title: "Take a course",
    roles: ["staff"],
    intro: "Courses from your company are in the staff app. You can stop and carry on later.",
    steps: [
      "In the staff app, open Home and tap My courses under Quick links.",
      "Tap a course. Read or watch each lesson, then tap I've done this.",
      "For a quiz, choose your answers and tap Check my answers. If you don't pass, change the answers marked Not quite and try again.",
      "When every lesson is done, tap Your certificate to see or save it.",
    ],
    wrong: ["The video doesn't play: tap Watch the video to open it, or ask HR to check the link."],
  },
  {
    slug: "paid-training",
    title: "Ask for and record paid training",
    roles: ["owner", "hr", "staff"],
    intro: "Outside courses the company pays for, with the cost and any bond period.",
    steps: [
      "Staff: in My courses, tap Ask for paid training, fill in the course, who runs it and the cost, and send it. It goes for approval like any request.",
      "Managers and HR: approve or decline it in Requests.",
      "HR: open Training, then Paid training, to see every request and record. Select Add to record one directly.",
      "Add the bond period in months when you edit it. The bond end date is worked out from the course end date.",
    ],
    wrong: ["A request isn't in Requests: check who approves paid training in Workspace, Who approves what."],
  },
  {
    slug: "run-a-review-round",
    title: "Run a review round",
    roles: ["owner", "hr", "manager"],
    intro: "Each person rates themselves, their manager adds their view, then the review is shared with them to read and sign off.",
    steps: [
      "Open Reviews and select New review round. Set the period, the due dates and who's in it, then select Create round.",
      "Select Open round. Everyone in it is asked to do their self review.",
      "When someone sends theirs, their manager gets a notification. Open the review to see their answers next to your form.",
      "Rate each question, give an overall rating and a summary, then select Finish review.",
      "Select Share with them. They read it in the staff app and sign it off, with a comment if they like.",
      "Close the round when everyone is done.",
    ],
    wrong: [
      '"No manager, HR reviews": that person has no manager on their profile, so HR fills in the manager part.',
      "Someone joined after the round opened: select Add new joiners on the round.",
    ],
  },
  {
    slug: "your-review",
    ...
    roles: ["staff"],
    intro: "When a review round starts, you rate how the period went. Your manager then adds their view and shares it with you.",
    steps: [
      "Open the notification, or tap My reviews under Quick links on Home.",
      "Rate each question from 1 to 5 and add examples. Tap Save for later if you need a break.",
      "Tap Send to my manager. You can't change your answers after that.",
      "When your manager shares the review, read their view and tap I've read my review. You can add a comment.",
    ],
    wrong: ['"Answer every question": fill in the ones still empty. Questions marked optional can be left.'],
  },
  {
    slug: "set-goals",
    title: "Set and update goals",
    roles: ["owner", "hr", "manager", "staff"],
    intro: "A few clear goals for the company, each department and each person, with progress everyone can follow.",
    steps: [
      "Office: open Goals and select Add a goal. Choose whose goal it is, what it is and how it's measured.",
      "Staff: in the staff app, open My goals and tap Add.",
      "To record progress, select Update progress, move the slider, set the status and say what changed.",
      "Company goals are visible to everyone. Department goals are visible to that department.",
    ],
    wrong: ["You can't delete your own goal: mark it as cancelled instead, or ask your manager."],
  },
  {
    slug: "run-a-survey",
    title: "Run a staff survey",
    roles: ["owner", "hr"],
    intro: "Ask staff how things are going. Anonymous surveys never show who gave which answer.",
    steps: [
      "Open Surveys and select New survey. Four starter questions are added for you; change them as you like.",
      "Choose whether it's anonymous, who gets it and when it closes, then select Save survey.",
      "Select Open survey. Everyone it's for gets a notification.",
      "Open the survey to see how many have replied and the results. For anonymous surveys, results show once enough people reply.",
      "Select Close survey when you're done.",
    ],
    wrong: ["Results are hidden: the survey is anonymous and not enough people have replied yet. For a small team, lower the number before you open the next one."],
  },
];
