...
const SECTIONS = {
  personal: z.object({
    ...
    preferred_name: opt,
    gender: z.union([z.literal(""), z.enum(["male", "female"])]).transform((v) => v || null).optional(),
    date_of_birth: optDate,
    marital_status: z.union([z.literal(""), z.enum(["Single", "Married", "Divorced", "Widowed"])]).transform((v) => v || null).optional(),
    nationality: opt,
